import { createTask, getTask } from '../../src/controllers/tasks.controller';
...
describe('tasks.controller', () => {
  describe('createTask', () => {
    it('responde 201 y task info', async () => {
      ...
      jest.spyOn(require('../../src/services/task.service'), 'createTask').mockResolvedValue(fakeTask);
  ...
  describe('getTask', () => {
    it('responde con status y price si pending', async () => {
      ...
      jest.spyOn(require('../../src/services/task.service'), 'getTask').mockResolvedValue(fakeTask);
    ...
    it('lanza 404 si no existe', async () => {
      const req = { params: { taskId: 'id' } } as any;
      const res = {} as any;
      jest.spyOn(require('../../src/services/task.service'), 'getTask').mockResolvedValue(null);
